...
def run():
  ...
  driver.find_element(By.CSS_SELECTOR, '#nxTsOv > div > div.MainContainer._travel_header.MainContainer-vjtko > div.PanelHeader-vpb6F > div.TabList-Erooo._scroll_wrapper > div.scroll-D9KKR._scroller > ul > li:nth-child(5) > a > span')
  # .click()
  # time.sleep(3)
  print("이게 정상된건가바")
  ...
  #   By.CSS_SELECTOR,
  #   '#nxTsOv > div > div.MainContainer._travel_header.MainContainer-vjtko > div.PanelHeader-vpb6F > div.TabList-Erooo._scroll_wrapper > div.scroll-D9KKR._scroller > ul > li:nth-child(5) > a > span'
  # )
  ...
  for item in item_list:
    ...
    print('추출한 정보 : ', int(rank[0]), name, description, category, score)
